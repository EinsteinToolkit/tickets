...
Map [DefineTensor,
     {normal, tangentA, tangentB, dir,
      ...
      phi, gt, At, Xt, Xtn, alpha, A, beta, B, Atm, Atu, trA, chi2Ats, trchi2Ats,
      dottrK, dotXt,
      cXt, cS, cA,
      e4phi, em4phi, em2phi, ddetg, detgt, gtu, ddetgt, dgtu, ddgtu, Gtl, Gtlu, Gt,
      Rt, chi2Rphi, gK,
      T00, T0, T, rho, S,
      x, y, z, r,
      epsdiss}];
...
evolCalc =
{
  ...
  *)
  ...
  Shorthands -> {dir[ua],
                 ...
                 Atm[ua,lb], Atu[ua,ub],
                 e4phi, em4phi, em2phi, cdphi[la], chicdphi[la], chi2cdphi2[la,lb], g[la,lb], detg,
  ...
  Equations -> 
  {
    ...
    fac1 -> IfThen [conformalMethod, -1/2, Exp[-2 phi]],
    chicdphi[la] -> fac1 CDt[phi,la],
    fac2 -> IfThen [conformalMethod, 1/2, 0],
    chi2cdphi2[la,lb] -> fac1 phi CDt[phi,la,lb] + fac2 CDt[phi,la] CDt[phi,lb],
    ...
    em2phi      -> IfThen [conformalMethod, phi, Exp[-2 phi]], 
    em4phi      -> em2phi^2,
    e4phi       -> 1 / em4phi,
    ...
    dot[phi]       -> IfThen [conformalMethod, 1/3 phi, -1/6] alpha trK
                      ...
                      + C1 dt alpha mH IfThen [conformalMethod, -2 phi, 1],
...
enforceCalc =
{
  ...
  Equations -> 
  {
    ...
    gt[la,lb] -> gt[la,lb]/detgtExpr^(1/3)
...
constraintsCalc =
{
  ...
  Shorthands -> {detgt, ddetgt[la], gtu[ua,ub],
                 ...
                 Rt[la,lb], chi2Rphi[la,lb], chi2R[la,lb], trR, Atm[la,lb],
...
(*    gK[la,lb,lc] -> + 4 e4phi PD[chi,lc] At[la,lb] + e4phi CD[At[la,lb],lc]
...
(*{
  ...
  {
    Name -> C1,
    Description -> "constraint-damping coefficient",
    AllowedValues -> {{Value -> "(0:*", Description -> "Positive"}},
    Default -> 0
  },
  {
  ...
  {
    Name -> C4,
    Description -> "Yo term coefficient",
    AllowedValues -> {{Value -> "(0:*", Description -> "Positive"}},
    Default -> 0
  }
};
